        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.service.store') }}" class="form-row" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" class="form-control" id="short_description" rows="3" placeholder="Short description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="long_description" class="form-control" id="long_description" rows="5" placeholder="Long description"></textarea>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div id="prices_list">
                                    <div class="features">
                                        <input type="text" name="prices[]" placeholder="Prices" class="form-control">
                                    </div>
                                </div>
