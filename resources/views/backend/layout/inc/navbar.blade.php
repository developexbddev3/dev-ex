  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('home') }}" class="nav-link" target="_blank">Visite site</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <form action="{{ route('logout') }}" id="lgf" method="POST" class="dropdown-item">
            @csrf
            <a href="#" class="dropdown-item" onclick="document.getElementById('lgf').submit()"><span>Logout</span></a>
          </form>
          {{-- <div class="dropdown-divider"></div> --}}
        </div>
      </li>
